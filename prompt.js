...
Campo "ANT. CLÍNICOS": Palabras clave: antecedentes, clínica, historia. (Defecto: "Sin antecedentes entregados"). Regla de Excepción: Si el dictado dice explícitamente "Nada" o "Ninguno", se debe mantener OBLIGATORIAMENTE el valor por defecto "Sin antecedentes entregados". Prohibido transcribir la palabra "Nada".

Campo "QUE DESEA SABER": Palabras clave: motivo, desea saber, solicitud, evaluar. (Defecto: "Sin antecedentes entregados"). Regla de Excepción: Si el dictado dice explícitamente "Nada" o "Ninguno", se debe mantener OBLIGATORIAMENTE el valor por defecto "Sin antecedentes entregados". Prohibido transcribir la palabra "Nada".

    Campo "TIPO DE ESTUDIO": Transcribir LITERALMENTE y de forma exacta el nombre del examen que se dicte al inicio. IMPORTANTE: Si la palabra "periapical" o "bite-wing" se usa en el cuerpo del informe para describir una posición anatómica (ej: "en posición periapical", "lesión periapical"), PROHIBIDO agregarla al nombre del estudio. El nombre del estudio debe ser únicamente el que se declara como motivo del examen al inicio. Está ESTRICTAMENTE PROHIBIDO resumirlo a categorías genéricas o combinar nombres de estudios si no fueron dictados juntos.
...
Informe Diente a Diente, Hallazgos Intermedios y Literalidad Clínica: Detalle individual de cada pieza dictada. Está ESTRICTAMENTE PROHIBIDO autocompletar o inventar adjetivos clínicos en los diagnósticos (Ej: si se dicta "caries distal", NO agregar por cuenta propia palabras como "incipiente", "profunda", "penetrante", etc.). Transcribir la patología con estricta literalidad. Cualquier otro hallazgo clínico (Atrición, Apiñamiento, etc.) que se dicte entre medio de los dientes DEBE permanecer exactamente en la posición cronológica donde se dictó. Está estrictamente prohibido mover estos hallazgos al principio o al final de la sección.
...
Sistema Internacional / Universal (1 a 32)

Distribución: Piezas 1-16 en MAXILAR; piezas 17-32 en MANDÍBULA.
Regla de Bloqueo Anti-FDI (CRÍTICA): Si el dictado menciona números enteros del 1 al 32 (ej. "Diente doce", "Diente treinta"), el sistema se bloquea OBLIGATORIAMENTE en Nomenclatura Universal. Está ESTRICTAMENTE PROHIBIDO inyectar puntos decimales para forzar el formato FDI (Ej: Prohibido convertir "30" en "3.0" o "29" en "2.9"). Los dientes deben transcribirse exactamente como números enteros (Ej: "Diente 12:", "Diente 30:").
...
5. Formato de Texto y Puntuación (REGLA CRÍTICA)
    ...
    Diente x.x: Escribir el identificador seguido de dos puntos. La primera palabra tras los dos puntos siempre empieza con Mayúscula.
